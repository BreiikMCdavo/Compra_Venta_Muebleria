...
<nav class="sb-sidenav accordion" id="sidenavAccordion" 
     style="background-color:rgb(23, 44, 163); color: white;">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <!----Compras---->
                @can('ver-compra')
                    <a class="nav-link text-white collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseCompras"
                ...
                <!----Ventas---->
                @can('ver-venta')
                    <a class="nav-link text-white collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapseVentas"
                        aria-expanded="false" aria-controls="collapseLayouts">
